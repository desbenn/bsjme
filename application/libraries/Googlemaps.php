...
class Googlemaps extends Admin_Controller {
	...
	var $apiKey						= 'AIzaSyDPoOxlwihvTQKW1fLTDZUZjsP3xcfQTgY'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "47.264127, 106.416363";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
