...
<svg baseprofile="tiny" fill="#d4af37" height="397" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1000 397" width="1000" xmlns="http://www.w3.org/2000/svg">
 ...
 <a xlink:title="Clarendon (<?php echo $total_consultation_county_1370 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
 ...
 onmouseout="this.style.stroke = '#ffffff'; this.style['stroke-width'] = 2";>
 </path>
</a>

<a xlink:title="Hanover (<?php echo $total_consultation_county_1371 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Manchester (<?php echo $total_consultation_county_1372 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Saint Elizabeth (<?php echo $total_consultation_county_1373 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Saint James (<?php echo $total_consultation_county_1374 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Trelawny (<?php echo $total_consultation_county_1375 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Westmoreland (<?php echo $total_consultation_county_1376 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Kingston (<?php echo $total_consultation_county_1377 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
 <path d="M753 275.8l-3.4-3.3-5.9-1.4-13.8-0.2-9.4 0.2-6.5-3.9 1.5-4.4 0.8-1.8 3.5-2.3 4.6-1.9 3.8-1 11.8-0.6 6.8 1.6 4.5 2.4 3.8 8.9 0.4 6.2-2.5 1.5z" id="1377" name="Kingston"
 onmouseover="this.style.stroke = '#ff0000'; this.style['stroke-width'] = 5";
 onmouseout="this.style.stroke = '#ffffff'; this.style['stroke-width'] = 2";>
 </path>
</a>

<a xlink:title="Portland (<?php echo $total_consultation_county_1378 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Saint Ann (<?php echo $total_consultation_county_1379 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Saint Catherine (<?php echo $total_consultation_county_1380 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Saint Mary (<?php echo $total_consultation_county_1381 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Saint Andrew (<?php echo $total_consultation_county_1382 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
...
<a xlink:title="Saint Thomas (<?php echo $total_consultation_county_1383 ?>)" stroke="#ffffff"  stroke-width="2" fill="#d4af37"; >  
