...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><img width="25" height="25" data-toggle="tooltip" data-placement="bottom" title="Some information about the technical advice." src="<?php echo base_url('assets/images/question.png'); ?>" /></li>
    </ol>
  </section>
...
<!----------------------------------------------------------------------------------------------------->
      ...
      <ul class="nav nav-tabs">
        <li class="<?php echo (($active_tab === 'technicalAdvice') ? 'active' : '') ?>"><a data-toggle="tab" href="#technicalAdvice">Technical Advice</a></li>
        <li class="<?php echo (($active_tab === 'client_work_plan') ? 'active' : '') ?>"><a data-toggle="tab" href="#client_work_plan">Client Work Plan</a></li>
        <li class="<?php echo (($active_tab === 'internal_cost_plan') ? 'active' : '') ?>"><a data-toggle="tab" href="#internal_cost_plan">Internal Cost Plan</a></li>    
...
<!----------------------------------------------------------------------------------------------------->
        ...
        <?php if(empty($this->session->userdata('directory'))) {
          ...
          <?php if(empty($this->session->userdata('consultation_id'))) {
                $consultation_id = array('id' => $technical_advice_data['id']);
...
<div id="consultation" class="tab-pane fade <?php echo (($active_tab === 'technicalAdvice') ? 'in active' : '') ?>">  
