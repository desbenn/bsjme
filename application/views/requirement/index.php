...
<!----------------------------------------------------------------------------------------------------->        
        ...
        <?php if(in_array('createRequirement', $user_permission)): ?>
            <a href="<?php echo base_url('requirement/create') ?>" class="btn btn-primary">Add Requirement</a>          
        <?php endif; ?>
...
<?php if(in_array('deleteRequirement', $user_permission)): ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('requirement/remove') ?>" method="post" id="removeForm">
